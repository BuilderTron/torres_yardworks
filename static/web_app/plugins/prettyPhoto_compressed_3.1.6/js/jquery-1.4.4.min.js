...
(function (E, B) {
    ...
    (function () {
        ...
        k.filter = function (g, i, n, m) {
            for (
                var p, q, u = g, y = [], F = i, M = i && i[0] && k.isXML(i[0]); g && i.length;
                ...
                find: {
                    ...
                    NAME: function (g, i) {
                        if (typeof i.getElementsByName !== "undefined") {
                            for (
                                var n = [], m = i.getElementsByName(g[1]), p = 0, q = m.length; p < q; p++
                            )
    ...
    c.fn.extend({
        find: function (a) {
            for (
                var b = this.pushStack("", "find", a), d = 0, e = 0, f = this.length; e < f; e++
            ) {
                d = b.length;
                c.find(a, this[e], b);
                if (e > 0)
    ...
    c.extend({
        ...
        dir: function (a, b, d) {
            var e = [];
            for (
                a = a[b]; a && a.nodeType !== 9 && (d === B || a.nodeType !== 1 || !c(a).is(d));
    ...
    c.fn.extend({
        ...
        offsetParent: function () {
            return this.map(function () {
                for (
                    var a = this.offsetParent || t.body; a && !Ia.test(a.nodeName) && c.css(a, "position") === "static";
