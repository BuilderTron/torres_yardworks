    ...
    (a.MixItUp.prototype = {
            ...
            for (var d = 0; d < b._$toShow.length; d++) {
                ...
                f.css(c._in),
                    ...
                    ((e.style.width = e.dataset.finalWidth + "px"),
                        ...
                        (e.style.marginRight = -(e.dataset.finalWidth - e.dataset.interWidth) +
                            1 * e.dataset.finalMarginRight +
                            "px"),
                        (e.style.marginBottom = -(e.dataset.finalHeight - e.dataset.interHeight) +
            ...
            for (var d = 0; d < b._$pre.length; d++) {
                ...
                f.css(c),
                    ...
                    ((e.style.width = e.dataset.origWidth + "px"),
                        ...
                        (e.style.marginRight = -(e.dataset.origWidth - e.dataset.interWidth) +
                            1 * e.dataset.origMarginRight +
                            "px"),
                        e.dataset.origHeight - e.dataset.finalHeight &&
                        (e.style.marginBottom = -(e.dataset.origHeight - e.dataset.interHeight) +
        ...
        _animateTargets: function () {
                ...
                b._bindTargetDone(e),
                    ...
                    (d.dataset.origWidth - d.dataset.finalWidth &&
                        ...
                        ((d.style.height = d.dataset.finalHeight + "px"),
                            (d.style.marginBottom = -(d.dataset.finalHeight - d.dataset.interHeight) +
            ...
            for (var c = 0; c < b._$toHide.length; c++) {
                for (
                    var d = b._$toHide[c], e = a(d), g = b._getDelay(c), k = {}, i = 0; 2 > i; i++
                ) {
                    var j = 0 === i ? (j = b._prefix) : "";
