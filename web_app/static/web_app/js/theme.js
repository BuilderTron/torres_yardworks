    ...
    if ($("#doughnut-chartBox").length) {
        ...
        var myDoughnutChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [300, 50, 100],
                    backgroundColor: ["#CEC2AB", "#8D6DC4", "#F79468"],
                    hoverBackgroundColor: ["#3B415E", "#3B415E", "#3B415E"],
...
function maineNavToggle() {
    if ($("#main-navigation-wrapper .navbar-nav li .dropdown-submenu").length) {
        ...
        $("#main-navigation-wrapper .navbar-nav .dopdown-nav-toggler").on(
            "click",
            function () {
                if ($(this).hasClass("dopdown-nav-toggler-active")) {
                    $(this).removeClass("dopdown-nav-toggler-active");
                    $(
                        "#main-navigation-wrapper .navbar-nav li ul.dropdown-submenu"
                    ).fadeOut();
                } else {
                    $(
                        "#main-navigation-wrapper .navbar-nav .dopdown-nav-toggler"
                    ).removeClass("dopdown-nav-toggler-active");
                    $(
                        "#main-navigation-wrapper .navbar-nav li ul.dropdown-submenu"
                    ).hide();
                    var Self = $(this);
